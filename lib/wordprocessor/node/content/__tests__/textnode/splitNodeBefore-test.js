...
describe('splitNodeBefore', function() {
    ...
    it('simple', function() {
        let new_txt_node = simple_text_node.splitNodeBefore(5);
        ...
        expect(new_txt_node.text).toEqual('Hello');
    ...
    it('unicode', function() {
        let new_txt_node = unicode_text_node.splitNodeBefore(2);
        expect(unicode_text_node.text).toEqual('Iñtërnâtiônàlizætiøn');
        expect(new_txt_node.text).toEqual("💩நி");
        expect(changeCallback).toBeCalled();
    });

    it('before all chars', function() {
        let new_txt_node = unicode_text_node.splitNodeBefore(0);
    ...
    it('after all chars', function() {
        let new_txt_node = unicode_text_node.splitNodeBefore(unicode_text_node.size);
