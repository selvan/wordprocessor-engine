...
describe("Should support mergeAfterChild", function() {
    ...
    it('merge two nodes without a root parent', function() {
        ...
        containerNode1.mergeAfterChild(containerNode1.head, containerNode2);
        ...
        expect(_.filter(changeCallback1.mock.calls, (c) => {return c[0].type === ContainerNode.EVENTS.MERGE_AFTER_CHILD}).length).toBe(2);
        ...
        //console.log(Node.intendMarkup(containerNode1.toMarkup()));
    ...
    it('merge two nodes with a root parent', function() {
        ...
        containerNode1.mergeAfterChild(containerNode1.tail, containerNode2);
        let expectedNode1 = Markup.parse(`
                     <ContainerNode>
                        <TextNode>World1</TextNode>
                        <TextNode>World2</TextNode>
    ...
    it('merge with self', function() {
        ...
        containerNode1.mergeAfterChild(containerNode1.head, containerNode1);
        expect(changeCallbackParent).not.toBeCalled();
    });
});